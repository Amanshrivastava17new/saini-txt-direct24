...
API_ID = int(environ.get("API_ID", "29168687"))
API_HASH = environ.get("API_HASH", "e03f5b9029ac3f2cde701fe15a150d38")
...
AUTH_USER = os.environ.get('AUTH_USERS', '5764696199').split(',')
